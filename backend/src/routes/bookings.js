...
// Helper: coerce value to number or fallback
...
// Map DB row → camelCase booking object
  ...
  try {
    ...
    const { rows } = await db.query(`
      UPDATE bookings SET
        ...
        room_name=$5, room_category=$6, arrival=$7, departure=$8,
        arrival_time=$9, departure_time=$10, num_guests=$11, num_children=$12,
        children_ages=$13, meal_plan=$14, status=$15, source=$16,
        ota_platform=$17, booking_id=$18, agent_name=$19, base_rate=$20,
        extra_child_charge=$21, extra_bed=$22, extra_bed_charge=$23,
        discount=$24, advance_particulars=$25, advance_payment_type=$26,
        payment_status=$27, payment_mode=$28, total_amount=$29,
        paid_amount=$30, balance=$31, tags=$32, dnc=$33,
        is_multi_room=$34, rooms=$35, comments=$36, audit_trail=$37
      WHERE id=$38
      RETURNING *`,
      [
